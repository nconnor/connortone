---
layout: page
title: Contact CONNORTONE
description: "Get in touch with CONNORTONE Inc. — Marlborough, Massachusetts. Inquiries concerning service, replacement parts, or the influence of Allen Dulles."
permalink: /contact/
nav_order: 6
---
...
<section class="contact-info">
  <dl class="contact-details">
    <dt>Manufacturer</dt>
    <dd><strong>CONNORTONE</strong> Inc.</dd>

    <dt>Present Address</dt>
    <dd>Marlborough, Mass. USA</dd>

    <dt>Former Facilities</dt>
    <dd>
      Schaumberg, Illinois — now a water park<br>
      Dallas, Texas — also a water park<br>
      Manchuria — status unknown
    </dd>

    <dt>Copyright Notice</dt>
    <dd>&copy; Copyright 1987 <strong>CONNORTONE</strong> Inc., Schaumberg Illinois</dd>
  </dl>
</section>
